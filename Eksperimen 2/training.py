...
# model = unet_3d_with_groupnorm(128, 128, 128, 1, 4)
...
# --- Tentukan Path untuk Dataset BraTS 2021 ---
...
OUTPUT_DIR = 'C:/Aulia/Kumpulan Eksperimen/Eksperimen 17/Model/'
os.makedirs(OUTPUT_DIR, exist_ok=True)
MODEL_SAVE_PATH = os.path.join(OUTPUT_DIR, 'Unet_best.h5')
